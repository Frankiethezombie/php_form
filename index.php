    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="row justify-content-center">
                ...
                <form action="result.php" method="post" class="col-xs-12 col-lg-10" id="form">

                    <input id="website" name="website" type="text" value=""  />
                    
                    <div class="row justify-content-center" id="content">
                        <input type="text" name="fname" placeholder="first name" class="col-10" required>
                    </div>

                    <div class="row justify-content-center" id="content">
                        <input type="text" name="lname" placeholder="last name" class="col-10" required>

                    </div>
                    
                    <div class="row justify-content-center" id="content">
                        <input type="email" name="mail" placeholder="email@mailexample.com" class="col-10" required>
                    </div>
                    
                    <div class="row justify-content-center" id="content">
                        <select name="country" class="col-10" required>
                    ...
                    <div class="row justify-content-center" id="content">
                        <select name="subject" placeholder="problem category" class="col-10" required>
                    ...
                    <div class="row justify-content-center" id="content">
                        <textarea name="message"  cols="30" rows="10" placeholder="your message here" required></textarea>
                    </div>
